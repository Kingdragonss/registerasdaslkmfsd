    ...
    require("moment-duration-format");
      ...
      if(üs) {
        üyesayısı = üyesayısı.replace(/([0-9])/g, d => {
          return {
            '0': `<a:0_:809444319248252971>`,
'1': `<a:779046943963611177:809444326782140446> `,
'2': `<a:779046952205287444:809444335598436400>  `,
'3': `<a:3_:809444347715911690>`,
'4': `<a:779047145201860648:809444357211947078>`,                       
'5': `<a:5_:809444365327532102>`,
'6': `<a:hydra:809444374705733714>`,
'7': `<a:7_:809444384479117312> `,
'8': `<a:8_:809444390425985034>`,
'9': `<a:9_:809444399061794846>`}[d];
          })
        }
 ...
 const hgmesaj = (`<a:hydraalevv:808620322030878750> **__Η Y Đ Я Λ'ya__** ** hoşgeldin <@${vader.id}> <a:hydraalevv:808620322030878750> 
 
 • Seninle beraber sunucumuz `+üyesayısı+` kişiye ulaştı. 
 
 • Hesabın __(`  + moment(member.user.createdAt).format("DD MMMM YYYY dddd") +`)__  oluşturulduğu için `  + kontrol + ` 
 
 • Kaydını tamamlamak için herhangi bir __\`V.Confirmed\`__ teyit odasına girmen yeterlidir.
